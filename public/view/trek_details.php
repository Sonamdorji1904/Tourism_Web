                ...
                <div class="tour-main-content">
                    ...
                    <div class="tour-section">
                        ...
                        <div class="accordion" id="itinerary-accordion">
                            <?php
                            for ($i = 0; $i < count($trekItineraries); $i++) {
                                $itineraryId = $trekItineraries[$i]['id'] ?? '';
                                $trek_id = $trekItineraries[$i]['trek_id'] ?? '';
    ...
    <section class="similar-tours">
        ...
        <div class="container">
            ...
            <div class="tours-grid">
                ...
                $getRandomTreks = $TrekModel->getRandomTreksExcluding($trekId, 3);

                if ($getRandomTreks) {
                    foreach ($getRandomTreks as $trek) {
                        $itinerayId = $trek['id'] ?? '';
                        $title = $trek['title'] ?? '';
