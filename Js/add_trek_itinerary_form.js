document.addEventListener("DOMContentLoaded", function() {
  ...
  addBtn.addEventListener("click", function() {
    ...
    const trekIdInput = document.querySelector('input[name="trek_id"]');
    const trekId = trekIdInput ? trekIdInput.value : "";

    const xhr = new XMLHttpRequest();

    xhr.open(
      "GET",
      `get_trek_itinerary_form.php?day=${nextDay}&trek_id=${encodeURIComponent(
        trekId
      )}`,
      true
    );
