...
if (isset($_FILES['tour_image']) && $_FILES['tour_image']['error'] !== UPLOAD_ERR_NO_FILE) {
    ...
    $uploadedImagePath = 'uploads/tour_images/' . $filename;
}
...
try {
    $saveStatus = $tourCard->saveContent($data);
} catch (Throwable $e) {
