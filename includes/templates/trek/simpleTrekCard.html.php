<div class="tour-card">
    <div class="tour-image">
        <img src="<?php echo $imageFilePath; ?>" alt="Trek title">
    ...
    <div class="tour-content">
        ...
        <a href="/Happiness horizone/admin/get_trek_details.php?id=<?php echo urlencode($itinerayId ?? ''); ?>" class="btn btn-outline">View Details</a>
    </div>
</div>